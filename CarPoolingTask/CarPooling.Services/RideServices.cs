...
namespace CarPooling_Services
{
    public class RideServices : IRide
    {
        ...
        public RideServices(DatabaseContext dbContext,ILog _logger)
        {
        ...
        public async Task<List<BookRide>> GetBookedRide(int userId)
        {
            ...
            {
                _logger.AddErrorLog(ex.Source,ex.Message);
        ...
        public async Task<BookRide> BookRide(int selectedRideId, BookRide bookRideRequest)
        {
            try
            {
                ...
                {
                    Console.WriteLine("empty intermediate stops ");
                }
               ...
               /* Console.WriteLine(completePath.Count);
                ...
                {
                    Console.WriteLine("----------------------------------");
                    Console.WriteLine("this is a stop at complete path"+completePath[i] + "the stop ends here ");
                    Console.WriteLine("this is the index of that stop "+ i);
                    Console.WriteLine("----------------------------------");
                }*/
